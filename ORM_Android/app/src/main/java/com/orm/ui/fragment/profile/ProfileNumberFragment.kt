...
class ProfileNumberFragment : Fragment() {
    private var _binding: FragmentProfileNumberBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentProfileNumberBinding.inflate(inflater, container, false)
