...
import com.orm.databinding.FragmentClubApplyBinding
...
@AndroidEntryPoint
class ClubApplyFragment : Fragment() {
    private var _binding: FragmentClubApplyBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentClubApplyBinding.inflate(inflater, container, false)
