...
public class TraceController {
    ...
    @PostMapping("/create")
    public ResponseEntity<TraceResponseDto> createTrace(HttpServletRequest request, TraceCreationRequestDto traceCreationRequestDto) {
        String accessToken = request.getHeader(HEADER_AUTH);
        Integer userId = jwtUtil.getUserIdFromAccessToken(accessToken);
        TraceResponseDto traceResponseDto = traceService.createTrace(traceCreationRequestDto, userId);
